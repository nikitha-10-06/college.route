...
<script>
  const colleges = [
    ...
    },
    {
      ...
      place: "Hyderabad",
      courses: ["CSE", "ECE", "Civil"],
      description: "Well-known engineering college in Hyderabad.",
      about: "CMR College is known for providing quality education with a strong emphasis on research and innovation. It has modern infrastructure, industry tie-ups, and a student-centric learning environment.",
      image: "https://cmrcet.ac.in/assets/images/campus.jpg",
      eligibility: "Rank ≤200k",
      fee: "₹1.1L/yr"
    },
    {
      ...
      place: "Hyderabad",
      courses: ["CSE", "ECE", "Mechanical"],
      description: "Emerging private engineering college.",
      about: "Sree Dattha Institute promotes technical excellence through modern teaching methods and skilled faculty. It provides placement training and a supportive campus culture for student growth.",
      image: "https://sreedattha.ac.in/images/campus.jpg",
      eligibility: "Rank ≤250k",
      fee: "₹95k/yr"
    },
    {
      ...
      description: "Reputed institution offering technical education.",
      about: "Siddhartha Institute focuses on discipline, innovation, and practical training. It supports academic growth with experienced faculty and encourages entrepreneurial skills.",
      image: "https://siddhartha.ac.in/images/main.jpg",
      eligibility: "Rank ≤250k",
      fee: "₹90k/yr"
    },
    {
      ...
      place: "Hyderabad",
      courses: ["CSE", "IT", "ECE"],
      description: "Popular engineering college with diverse programs.",
      about: "Guru Nanak Institutions offer state-of-the-art infrastructure, dedicated training programs, and active campus life. The college has strong academic and placement support.",
      image: "https://gniindia.org/assets/images/campus.jpg",
      eligibility: "Rank ≤200k",
      fee: "₹1.0L/yr"
    },
    {
      ...
      exams: ["collegeexam"],
      place: "Chennai",
      courses: ["CSE", "EEE", "Mech", "Medical"],
      description: "Deemed university with own entrance exam.",
      about: "Bharath University offers a wide range of programs in engineering and medicine. It is known for research, faculty expertise, and campus infrastructure. Admissions are based on the Bharath entrance exam.",
      image: "https://www.bharathuniv.ac.in/images/gallery1.jpg",
      eligibility: "BIHER Entrance",
      fee: "₹1.2L/yr"
    },
    {
      ...
      place: "Hyderabad",
      courses: ["CSE", "IT", "ECE"],
      description: "Consistently ranked among top Telangana colleges.",
      about: "CVR College emphasizes technical skills, innovation, and career readiness. The institution is known for quality faculty, labs, and an active placement cell.",
      image: "https://cvr.ac.in/home/images/campus_view.jpg",
      eligibility: "Rank ≤180k",
      fee: "₹1.3L/yr"
    },
    {
      ...
      place: "Hyderabad",
      courses: ["CSE", "ECE", "Mechanical"],
      description: "Private college offering diverse technical programs.",
      about: "AVN Institute fosters a learning environment focused on technical education and personality development. The college provides practical exposure, value-added programs, and placement support.",
      image: "https://www.avniet.ac.in/images/campus-1.jpg",
      eligibility: "Rank ≤250k",
      fee: "₹95k/yr"
    }
  ];
